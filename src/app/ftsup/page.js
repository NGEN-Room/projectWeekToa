...
<div className="min-h-screen bg-white">
    <div className="text-black text-2xl"><button type="submit" className="bg-gray-300">Skip</button></div>
        ...
        <div className="relative text-black mb-20 "><button type="button">Selected content type</button>
        <img src="instagram.png" className="absolute w-20 h-20 flex flex-col"></img>
        </div>
        <div className="relative text-black mb-20"><button type="button">Selected content type</button>
